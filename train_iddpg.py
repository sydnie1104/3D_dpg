# train_iddpg.py - IDDPG多智能体训练脚本
"""
Independent DDPG: 每个agent完全独立训练
"""
import torch
...
def train():
    ...
    print(f"📐 每个agent独立训练（Independent）")
    ...
    try:
        for episode in range(1, Config.TOTAL_EPISODES + 1):
            ...
            while not done:
                ...
                # 存储经验（每个agent独立存储）
                agent.push_experience(obs_list, actions, rewards, next_obs_list, dones)
